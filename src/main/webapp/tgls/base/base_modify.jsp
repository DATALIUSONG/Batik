...
<div class="cBody">
	<div class="console">
		<div class="layui-form-item" style="margin-left: 40px;">
			...
			<a class="layui-btn" href="base_list.html" onclick="addbasicInfo('basicInfo')">关闭/退出</a>
		</div>
	</div>
				...
				<div style="width: 100%; height: auto; position: relative;">
					<table style="width: auto;height: auto;">
						<td>
							...
							<div class="add_window_desc">
								...
								<div id='depart' class="box">
									...
									<script type="text/javascript">
										$(function() {
											$("#tab2").on("click", ":button", function(event) {
												$("#requestDeportment").val($(this).closest("tr").find("td").eq(0).text());
											});
										});
									</script>
						...
						<td>
							...
							<div class="add_window_desc">
								<font> 修改原因:</font> <input type="text" id="modifyReason1" />
							</div>
						</td>
					</table>
					...
					<div style="width: 100%; height: 50px; text-align: center; margin-top: 30px;">
						...
						<button id="saveBtn" style="width: 60px; height: 35px; background: #209e85;" onclick="addGoods()">提交</button>
					</div>
				</div>
			</div>
		</div>
	...
	function showGoodsList(list) {
		...
		for(var i = 0; i < list.length; i++) {
			...
			html += '<td>' +
					...
					'		<font onclick="edit_win(' + '\'' + list[i].materialTrackingCode + '\'' + ')">修改</font>' +
					'	</div>' +
					'</td>' +
					'</tr>';
		}
