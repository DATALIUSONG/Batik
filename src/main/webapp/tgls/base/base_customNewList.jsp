		...
		<div class="layui-form-item" style="margin-left: 40px;">
			...
			<form id="upform" enctype='multipart/form-data' style="display:none;">
				<div class="form-group">
					...
					<input id="upteainput" name="upfile" type="file" class="form-control-file" onchange="getvl(this)">
				</div>
			</form>
			<a class="layui-btn" id="uptea" type="button" class="btn btn-primary">附件</a>
