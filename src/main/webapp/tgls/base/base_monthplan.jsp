		...
		<div class="cBody">
			<div class="console">
				<div class="layui-form-item" style="margin-left: 40px;">
					...
					<a class="layui-btn" href="../print/base_print.html">打印</a>
					...
					<a class="layui-btn" href="delete_list.html" onclick="menuCAClick('goods_list.html',this)">删除</a>
			...
			<div class="add_plan_desc">
				...
				<!--月度计划 需要改input的id-->
				<div id="third_need" style="margin-left: 80px;width: 100%;margin-top: 20px;">
					<font><strong>需求月份</strong></font>
					<input type="month" id="requestplanmonth" />
					<div id='Monthdepart' class="box">
					...
					<font><strong>审批状态</strong></font> <input id="approvalStatus" readonly="readonly" name="approvalStatus" type="text" style="height: 20px;width: 50px;" readonly="true" />
					<div style="margin-left: 95px;width: 70%;margin-top: 20px;">
						<font><input type="checkbox" id="allAndNotAll1" /><strong>是否预算内计划</strong></font>
						<font style="margin-left: 100px;"><strong>需求计划状态</strong></font> <input id="requestStatus" name="requestStatus" type="text" readonly="true" />
					</div>
							...
							<div style="height:500px;background: white;margin: 0 auto;overflow-y:scroll;padding-bottom: 15px;margin-left: 12px;margin-right: 12px;">
								...
								<div id="myTabContent" class="tab-content">
									<div class="tab-pane fade in active" id="first_table">
										<table>
											<thead>
												<th><input type="checkbox" id="allAndNotAll" /> 行号</th>
												<th>物料分类编码</th>
												<th>物料分类名称</th>
												<th>物料编码</th>
												<th>物料名称</th>
